...
import { Building2, Rocket, User, HelpCircle, ChevronRight } from 'lucide-react'

const quickLinks = [
  { icon: Building2, label: 'View business bank account', href: '#' },
  { icon: Rocket, label: 'View start up account', href: '#' },
  { icon: User, label: 'View sole trader account', href: '#' },
  { icon: HelpCircle, label: 'Help and support', href: '#' },
]
