...
export default function PrivateContent() {
  ...
  return (
    <section className="section-padding bg-white" ref={sectionRef} style={{ opacity: 0 }}>
      <div className="container-seagate max-w-4xl">
        <h2 className="text-3xl md:text-4xl font-bold text-[#1A1A1A] mb-6">
          We call it 'relationship-led banking.'
        </h2>
        <p className="text-base text-[#595959] mb-8 leading-relaxed">
          At Seagate Metal Private Banking, we understand that many of our customers lead demanding lives and have needs that go beyond conventional banking. That's why we take care of them personally. We introduce customers to specialist partners to ensure they safely navigate the complex world of wealth.
        </p>
